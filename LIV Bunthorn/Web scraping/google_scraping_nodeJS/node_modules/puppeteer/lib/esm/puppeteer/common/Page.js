...
import { _createJSHandle } from './JSHandle.js';
...
export class Page extends EventEmitter {
    ...
    constructor(client, target, ignoreHTTPSErrors, screenshotTaskQueue) {
        ...
        __classPrivateFieldGet(this, _Page_frameManager, "f").on(FrameManagerEmittedEvents.FrameAttached, (event) => this.emit("frameattached" /* PageEmittedEvents.FrameAttached */, event));
        __classPrivateFieldGet(this, _Page_frameManager, "f").on(FrameManagerEmittedEvents.FrameDetached, (event) => this.emit("framedetached" /* PageEmittedEvents.FrameDetached */, event));
        __classPrivateFieldGet(this, _Page_frameManager, "f").on(FrameManagerEmittedEvents.FrameNavigated, (event) => this.emit("framenavigated" /* PageEmittedEvents.FrameNavigated */, event));
        const networkManager = __classPrivateFieldGet(this, _Page_frameManager, "f").networkManager();
        networkManager.on(NetworkManagerEmittedEvents.Request, (event) => this.emit("request" /* PageEmittedEvents.Request */, event));
        networkManager.on(NetworkManagerEmittedEvents.RequestServedFromCache, (event) => this.emit("requestservedfromcache" /* PageEmittedEvents.RequestServedFromCache */, event));
        networkManager.on(NetworkManagerEmittedEvents.Response, (event) => this.emit("response" /* PageEmittedEvents.Response */, event));
        networkManager.on(NetworkManagerEmittedEvents.RequestFailed, (event) => this.emit("requestfailed" /* PageEmittedEvents.RequestFailed */, event));
        networkManager.on(NetworkManagerEmittedEvents.RequestFinished, (event) => this.emit("requestfinished" /* PageEmittedEvents.RequestFinished */, event));
    ...
    async waitForRequest(urlOrPredicate, options = {}) {
        const { timeout = __classPrivateFieldGet(this, _Page_timeoutSettings, "f").timeout() } = options;
        return helper.waitForEvent(__classPrivateFieldGet(this, _Page_frameManager, "f").networkManager(), NetworkManagerEmittedEvents.Request, (request) => {
    ...
    async waitForResponse(urlOrPredicate, options = {}) {
        const { timeout = __classPrivateFieldGet(this, _Page_timeoutSettings, "f").timeout() } = options;
        return helper.waitForEvent(__classPrivateFieldGet(this, _Page_frameManager, "f").networkManager(), NetworkManagerEmittedEvents.Response, async (response) => {
            if (helper.isString(urlOrPredicate))
    ...
    async waitForFrame(urlOrPredicate, options = {}) {
        ...
        const eventRace = Promise.race([
            helper.waitForEvent(__classPrivateFieldGet(this, _Page_frameManager, "f"), FrameManagerEmittedEvents.FrameAttached, predicate, timeout, __classPrivateFieldGet(this, _Page_instances, "m", _Page_sessionClosePromise).call(this)),
            helper.waitForEvent(__classPrivateFieldGet(this, _Page_frameManager, "f"), FrameManagerEmittedEvents.FrameNavigated, predicate, timeout, __classPrivateFieldGet(this, _Page_instances, "m", _Page_sessionClosePromise).call(this)),
    ...
    async createPDFStream(options = {}) {
        ...
        return helper.getReadableFromProtocolStream(__classPrivateFieldGet(this, _Page_client, "f"), result.stream);
    }
    /**
     * @param options -
     * @returns
...
_Page_closed = new WeakMap(), _Page_client = new WeakMap(), _Page_target = new WeakMap(), _Page_keyboard = new WeakMap(), _Page_mouse = new WeakMap(), _Page_timeoutSettings = new WeakMap(), _Page_touchscreen = new WeakMap(), _Page_accessibility = new WeakMap(), _Page_frameManager = new WeakMap(), _Page_emulationManager = new WeakMap(), _Page_tracing = new WeakMap(), _Page_pageBindings = new WeakMap(), _Page_coverage = new WeakMap(), _Page_javascriptEnabled = new WeakMap(), _Page_viewport = new WeakMap(), _Page_screenshotTaskQueue = new WeakMap(), _Page_workers = new WeakMap(), _Page_fileChooserInterceptors = new WeakMap(), _Page_disconnectPromise = new WeakMap(), _Page_userDragInterceptionEnabled = new WeakMap(), _Page_handlerMap = new WeakMap(), _Page_instances = new WeakSet(), _Page_initialize = async function _Page_initialize() {
    ...
    if (args)
        args.map((arg) => helper.releaseObject(__classPrivateFieldGet(this, _Page_client, "f"), arg));
    if (source !== 'worker')
...
async function _Page_setTransparentBackgroundColor() {
    ...
    if (!__classPrivateFieldGet(this, _Page_disconnectPromise, "f"))
        __classPrivateFieldSet(this, _Page_disconnectPromise, new Promise((fulfill) => __classPrivateFieldGet(this, _Page_client, "f").once(CDPSessionEmittedEvents.Disconnected, () => fulfill(new Error('Target closed')))), "f");
