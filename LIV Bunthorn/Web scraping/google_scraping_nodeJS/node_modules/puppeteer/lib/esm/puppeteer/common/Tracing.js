...
export class Tracing {
    ...
    async stop() {
        ...
        __classPrivateFieldGet(this, _Tracing_client, "f").once('Tracing.tracingComplete', async (event) => {
            try {
                const readable = await helper.getReadableFromProtocolStream(__classPrivateFieldGet(this, _Tracing_client, "f"), event.stream);
                const buffer = await helper.getReadableAsBuffer(readable, __classPrivateFieldGet(this, _Tracing_path, "f"));
