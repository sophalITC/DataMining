...
export class PuppeteerNode extends Puppeteer {
    ...
    get _launcher() {
        if (!__classPrivateFieldGet(this, _PuppeteerNode_lazyLauncher, "f") ||
            ...
            __classPrivateFieldSet(this, _PuppeteerNode_lazyLauncher, Launcher(__classPrivateFieldGet(this, _PuppeteerNode_projectRoot, "f"), this._preferredRevision, this._isPuppeteerCore, this._productName), "f");
        }
