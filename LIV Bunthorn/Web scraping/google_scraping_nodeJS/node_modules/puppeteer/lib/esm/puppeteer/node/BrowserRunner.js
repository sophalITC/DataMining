...
import { helper, debugError, isErrorLike, isErrnoException, } from '../common/helper.js';
...
export class BrowserRunner {
    ...
    start(options) {
        ...
        if (handleSIGINT)
            __classPrivateFieldGet(this, _BrowserRunner_listeners, "f").push(helper.addEventListener(process, 'SIGINT', () => {
                this.kill();
                process.exit(130);
            }));
        if (handleSIGTERM)
            __classPrivateFieldGet(this, _BrowserRunner_listeners, "f").push(helper.addEventListener(process, 'SIGTERM', this.close.bind(this)));
        if (handleSIGHUP)
            __classPrivateFieldGet(this, _BrowserRunner_listeners, "f").push(helper.addEventListener(process, 'SIGHUP', this.close.bind(this)));
    }
    close() {
        ...
        helper.removeEventListeners(__classPrivateFieldGet(this, _BrowserRunner_listeners, "f"));
