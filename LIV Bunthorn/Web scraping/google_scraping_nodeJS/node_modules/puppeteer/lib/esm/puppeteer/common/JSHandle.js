...
export class JSHandle {
    ...
    async jsonValue() {
        ...
        return helper.valueFromRemoteObject(__classPrivateFieldGet(this, _JSHandle_remoteObject, "f"));
    }
    /**
    ...
    async dispose() {
        ...
        await helper.releaseObject(__classPrivateFieldGet(this, _JSHandle_client, "f"), __classPrivateFieldGet(this, _JSHandle_remoteObject, "f"));
    }
    /**
    ...
    toString() {
        ...
        return 'JSHandle:' + helper.valueFromRemoteObject(__classPrivateFieldGet(this, _JSHandle_remoteObject, "f"));
    }
}
