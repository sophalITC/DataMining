...
async function queryAXTree(client, element, accessibleName, role) {
    ...
    const filteredNodes = nodes.filter((node) => !node.role || node.role.value !== 'StaticText');
...
const waitFor = async (domWorld, selector, options) => {
    ...
    return domWorld._waitForSelectorInPage((_, selector) => globalThis.ariaQuerySelector(selector), selector, options, binding);
};
