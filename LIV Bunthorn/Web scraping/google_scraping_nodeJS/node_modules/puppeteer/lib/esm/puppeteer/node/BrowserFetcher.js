...
export class BrowserFetcher {
    ...
    async localRevisions() {
        ...
        return fileNames
            .map((fileName) => parseFolderPath(__classPrivateFieldGet(this, _BrowserFetcher_product, "f"), fileName))
            .filter((entry) => { var _a; return (_a = (entry && entry.platform === __classPrivateFieldGet(this, _BrowserFetcher_platform, "f"))) !== null && _a !== void 0 ? _a : false; })
...
function install(archivePath, folderPath) {
    ...
    if (archivePath.endsWith('.zip'))
        ...
        return mkdirAsync(folderPath).then(() => _installDMG(archivePath, folderPath));
    else
