...
class PuppeteerNode extends Puppeteer_js_1.Puppeteer {
    ...
    get _launcher() {
        if (!__classPrivateFieldGet(this, _PuppeteerNode_lazyLauncher, "f") ||
            ...
            __classPrivateFieldSet(this, _PuppeteerNode_lazyLauncher, (0, Launcher_js_1.default)(__classPrivateFieldGet(this, _PuppeteerNode_projectRoot, "f"), this._preferredRevision, this._isPuppeteerCore, this._productName), "f");
        }
