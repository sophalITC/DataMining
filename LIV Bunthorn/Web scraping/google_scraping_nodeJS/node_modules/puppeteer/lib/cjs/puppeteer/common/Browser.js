...
class Browser extends EventEmitter_js_1.EventEmitter {
    ...
    constructor(connection, contextIds, ignoreHTTPSErrors, defaultViewport, process, closeCallback, targetFilterCallback, isPageTargetCallback) {
        ...
        __classPrivateFieldSet(this, _Browser_targetFilterCallback, targetFilterCallback || (() => true), "f");
        ...
        __classPrivateFieldGet(this, _Browser_connection, "f").on(Connection_js_1.ConnectionEmittedEvents.Disconnected, () => this.emit("disconnected" /* BrowserEmittedEvents.Disconnected */));
     ...
     */
    targets() {
        return Array.from(__classPrivateFieldGet(this, _Browser_targets, "f").values()).filter((target) => target._isInitialized);
    }
    /**
...
_Browser_ignoreHTTPSErrors = new WeakMap(), _Browser_defaultViewport = new WeakMap(), _Browser_process = new WeakMap(), _Browser_connection = new WeakMap(), _Browser_closeCallback = new WeakMap(), _Browser_targetFilterCallback = new WeakMap(), _Browser_isPageTargetCallback = new WeakMap(), _Browser_defaultContext = new WeakMap(), _Browser_contexts = new WeakMap(), _Browser_screenshotTaskQueue = new WeakMap(), _Browser_targets = new WeakMap(), _Browser_ignoredTargets = new WeakMap(), _Browser_instances = new WeakSet(), _Browser_setIsPageTargetCallback = function _Browser_setIsPageTargetCallback(isPageTargetCallback) {
    ...
    const target = new Target_js_1.Target(targetInfo, context, () => __classPrivateFieldGet(this, _Browser_connection, "f").createSession(targetInfo), __classPrivateFieldGet(this, _Browser_ignoreHTTPSErrors, "f"), (_a = __classPrivateFieldGet(this, _Browser_defaultViewport, "f")) !== null && _a !== void 0 ? _a : null, __classPrivateFieldGet(this, _Browser_screenshotTaskQueue, "f"), __classPrivateFieldGet(this, _Browser_isPageTargetCallback, "f"));
...
class BrowserContext extends EventEmitter_js_1.EventEmitter {
    ...
    waitForTarget(predicate, options = {}) {
        return __classPrivateFieldGet(this, _BrowserContext_browser, "f").waitForTarget((target) => target.browserContext() === this && predicate(target), options);
    }
    /**
