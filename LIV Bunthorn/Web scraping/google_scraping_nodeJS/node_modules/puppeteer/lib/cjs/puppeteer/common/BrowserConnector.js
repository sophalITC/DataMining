...
async function _connectToBrowser(options) {
    ...
    return Browser_js_1.Browser._create(connection, browserContextIds, ignoreHTTPSErrors, defaultViewport, undefined, () => connection.send('Browser.close').catch(helper_js_1.debugError), targetFilter, isPageTarget);
}
