...
class Tracing {
    ...
    async stop() {
        ...
        __classPrivateFieldGet(this, _Tracing_client, "f").once('Tracing.tracingComplete', async (event) => {
            try {
                const readable = await helper_js_1.helper.getReadableFromProtocolStream(__classPrivateFieldGet(this, _Tracing_client, "f"), event.stream);
                const buffer = await helper_js_1.helper.getReadableAsBuffer(readable, __classPrivateFieldGet(this, _Tracing_path, "f"));
