...
class PipeTransport {
    constructor(pipeWrite, pipeRead) {
        ...
        __classPrivateFieldSet(this, _PipeTransport_eventListeners, [
            helper_js_1.helper.addEventListener(pipeRead, 'data', (buffer) => __classPrivateFieldGet(this, _PipeTransport_instances, "m", _PipeTransport_dispatch).call(this, buffer)),
    ...
    close() {
        ...
        helper_js_1.helper.removeEventListeners(__classPrivateFieldGet(this, _PipeTransport_eventListeners, "f"));
    }
}
