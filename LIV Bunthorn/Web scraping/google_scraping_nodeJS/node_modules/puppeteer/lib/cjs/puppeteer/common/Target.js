...
class Target {
    ...
    async worker() {
        ...
        if (!__classPrivateFieldGet(this, _Target_workerPromise, "f")) {
            ...
            __classPrivateFieldSet(this, _Target_workerPromise, __classPrivateFieldGet(this, _Target_sessionFactory, "f").call(this).then((client) => new WebWorker_js_1.WebWorker(client, __classPrivateFieldGet(this, _Target_targetInfo, "f").url, () => { } /* consoleAPICalled */, () => { } /* exceptionThrown */)), "f");
        }
