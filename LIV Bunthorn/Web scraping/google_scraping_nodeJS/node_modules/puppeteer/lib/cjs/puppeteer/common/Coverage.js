...
class JSCoverage {
    ...
    async start(options = {}) {
        ...
        __classPrivateFieldSet(this, _JSCoverage_eventListeners, [
            helper_js_1.helper.addEventListener(__classPrivateFieldGet(this, _JSCoverage_client, "f"), 'Debugger.scriptParsed', __classPrivateFieldGet(this, _JSCoverage_instances, "m", _JSCoverage_onScriptParsed).bind(this)),
            helper_js_1.helper.addEventListener(__classPrivateFieldGet(this, _JSCoverage_client, "f"), 'Runtime.executionContextsCleared', __classPrivateFieldGet(this, _JSCoverage_instances, "m", _JSCoverage_onExecutionContextsCleared).bind(this)),
        ], "f");
        await Promise.all([
    ...
    async stop() {
        ...
        helper_js_1.helper.removeEventListeners(__classPrivateFieldGet(this, _JSCoverage_eventListeners, "f"));
        const coverage = [];
...
class CSSCoverage {
    ...
    async start(options = {}) {
        ...
        __classPrivateFieldSet(this, _CSSCoverage_eventListeners, [
            helper_js_1.helper.addEventListener(__classPrivateFieldGet(this, _CSSCoverage_client, "f"), 'CSS.styleSheetAdded', __classPrivateFieldGet(this, _CSSCoverage_instances, "m", _CSSCoverage_onStyleSheet).bind(this)),
            helper_js_1.helper.addEventListener(__classPrivateFieldGet(this, _CSSCoverage_client, "f"), 'Runtime.executionContextsCleared', __classPrivateFieldGet(this, _CSSCoverage_instances, "m", _CSSCoverage_onExecutionContextsCleared).bind(this)),
        ], "f");
        await Promise.all([
    ...
    async stop() {
        ...
        helper_js_1.helper.removeEventListeners(__classPrivateFieldGet(this, _CSSCoverage_eventListeners, "f"));
