...
class JSHandle {
    ...
    async jsonValue() {
        ...
        return helper_js_1.helper.valueFromRemoteObject(__classPrivateFieldGet(this, _JSHandle_remoteObject, "f"));
    }
    /**
    ...
    async dispose() {
        ...
        await helper_js_1.helper.releaseObject(__classPrivateFieldGet(this, _JSHandle_client, "f"), __classPrivateFieldGet(this, _JSHandle_remoteObject, "f"));
    }
    /**
    ...
    toString() {
        ...
        return 'JSHandle:' + helper_js_1.helper.valueFromRemoteObject(__classPrivateFieldGet(this, _JSHandle_remoteObject, "f"));
    }
}
...
class ElementHandle extends JSHandle {
    ...
    async clickablePoint(offset) {
        ...
        const quads = result.quads
            .map((quad) => __classPrivateFieldGet(this, _ElementHandle_instances, "m", _ElementHandle_fromProtocolQuad).call(this, quad))
            .map((quad) => applyOffsetsToQuad(quad, offsetX, offsetY))
            .map((quad) => __classPrivateFieldGet(this, _ElementHandle_instances, "m", _ElementHandle_intersectQuadWithViewport).call(this, quad, clientWidth, clientHeight))
