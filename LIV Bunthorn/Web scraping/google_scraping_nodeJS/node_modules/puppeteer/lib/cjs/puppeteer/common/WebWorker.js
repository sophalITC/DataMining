...
class WebWorker extends EventEmitter_js_1.EventEmitter {
    ...
    constructor(client, url, consoleAPICalled, exceptionThrown) {
        ...
        __classPrivateFieldSet(this, _WebWorker_executionContextPromise, new Promise((x) => (__classPrivateFieldSet(this, _WebWorker_executionContextCallback, x, "f"))), "f");
        let jsHandleFactory;
        ...
        __classPrivateFieldGet(this, _WebWorker_client, "f").send('Runtime.enable').catch(helper_js_1.debugError);
        __classPrivateFieldGet(this, _WebWorker_client, "f").on('Runtime.consoleAPICalled', (event) => consoleAPICalled(event.type, event.args.map(jsHandleFactory), event.stackTrace));
        __classPrivateFieldGet(this, _WebWorker_client, "f").on('Runtime.exceptionThrown', (exception) => exceptionThrown(exception.exceptionDetails));
    }
    /**
