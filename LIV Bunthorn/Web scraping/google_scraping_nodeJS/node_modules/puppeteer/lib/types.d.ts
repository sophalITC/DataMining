...
export declare class ElementHandle<ElementType extends Element = Element> extends JSHandle<ElementType> {
     ...
     * ```
     */
    $$eval<ReturnType>(selector: string, pageFunction: EvaluateFn<Element[], unknown, ReturnType | Promise<ReturnType>>, ...args: SerializableOrJSHandle[]): Promise<WrapElementHandle<ReturnType>>;
    /**
...
export declare class HTTPResponse {
    ...
    export declare class Page extends EventEmitter {
        ...
        waitFor(selectorOrFunctionOrTimeout: string | number | Function, options?: {
            ...
            timeout?: number;
            polling?: string | number;
        }, ...args: SerializableOrJSHandle[]): Promise<JSHandle | null>;
        /**
         * Causes your script to wait for the given number of milliseconds.
         *
         * @remarks
